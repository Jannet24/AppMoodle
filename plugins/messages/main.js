...
define(requires, function (messagesTpl, recentTpl, conversationTpl, contactTpl, contactsTpl, searchTpl, bubblesTpl) {
    ...
    var plugin = {
        ...
        _renderConversation: function(userId, userName, userPicture, messagesReceived, messagesSent) {
            ...
            output = MM.tpl.render(MM.plugins.messages.templates.conversation.html, data);
            //toMM.panels.show('right', html, {title: userName});
        ...
        _renderMessages: function(messages) {
            ...
            output = MM.tpl.render(MM.plugins.messages.templates.messages.html, tpl);
            $('#principal').html(output).trigger("create");
                        ...
                        function(messagesSent) {
                            ...
                            MM.plugins.messages._getContacts(
                                function(contacts) {
                                    ...
                                    output = MM.tpl.render(MM.plugins.messages.templates.recent.html, data);
                                    $("#principal").html(output).trigger('create');
            ...
            var fillContacts = function(blockedUsers) {
                MM.plugins.messages._getContacts(
                    function(contacts) {
                        ...
                        output = MM.tpl.render(MM.plugins.messages.templates.contacts.html, {contacts: contacts});
        ...
        showContact: function(userId) {
            ...
            MM.plugins.messages._getContacts(
                function(contacts) {
                    ...
                    var output = MM.tpl.render(MM.plugins.messages.templates.contact.html, data);
                        ...
                        MM.plugins.messages._getRecentMessages(
                            ...
                            function(messagesSent) {
                                ...
                                if (messages.length > 0) {
                                    ...
                                    var previousDate = d.toLocaleDateString( {year: 'numeric', month:'long', day: '2-digit'});
